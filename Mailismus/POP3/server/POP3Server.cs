...
// https://github.com/greysoft/mailismus/blob/master/server/src/main/java/com/grey/mailismus/pop3/server/POP3Server.java
namespace com.grey.mailismus.pop3.server 
{
	...
	{
		private static readonly string TOKEN_HOSTNAME = "%H%";
		private static readonly string RSPMSG_GREET = "Mailismus POP3 Ready";
		private static readonly string RSPMSG_INVAUTH = "Authentication failed";
		private static readonly string RSPMSG_DUPAUTH = "This user is already connected";
		private static readonly string RSPMSG_NOSUCHMSG = "No such message";
		private static readonly string RSPMSG_ERRPROTO = "Bad command";
		private static readonly string RSPMSG_NEEDSSL = "Requires SSL mode";
		private static readonly string RSPMSG_TOP = "top of message follows";
		private static readonly string RSPMSG_EMPTYCHALLENGE = POP3Protocol.STATUS_AUTH;
		private static readonly string RSPMSG_OK = "";

		private enum PROTO_STATE { S_DISCON, S_AUTH, S_AUTHPASS, S_SASL, S_TRANSACT, S_UPDATE, S_STLS }
		private enum PROTO_EVENT
		{
			E_CONNECTED, E_DISCONNECT, E_DISCONNECTED, E_QUIT, E_STLS,
		...
		private static readonly byte S2_ENDED = 1 << 0; //we have already called endConnection()
		private static readonly byte S2_REQWAIT = 1 << 1; //we're waiting for the remote client to send a request
		...
		private static readonly class SharedFields
		{
			// assorted shared settings and objects
			readonly com.grey.base.collections.HashedSet<com.grey.@base.utils.ByteChars> currentUsers = new com.grey.base.collections.HashedSet<com.grey.@base.utils.ByteChars>();
			readonly com.grey.naf.BufferGenerator bufspec;
			readonly com.grey.mailismus.ms.maildir.MaildirStore ms;
			readonly com.grey.mailismus.directory.Directory dtory;
			readonly SaslAuthenticator saslauth;
			readonly java.security.MessageDigest md5proc;
			readonly com.grey.mailismus.Transcript transcript;
			readonly java.util.HashSet<POP3Protocol.AUTHTYPE> authtypes_enabled;
			readonly java.util.HashSet<POP3Protocol.AUTHTYPE> authtypes_ssl; //only allowed in SSL mode
			readonly com.grey.base.collections.ObjectWell<com.grey.base.sasl.PlainServer> saslmechs_plain;
			readonly com.grey.base.collections.ObjectWell<com.grey.base.sasl.CramMD5Server> saslmechs_cmd5;
			readonly com.grey.base.collections.ObjectWell<com.grey.base.sasl.ExternalServer> saslmechs_ext;
			readonly string capa_sasl; //SASL CAPA string for non-SSL mode
			readonly string capa_sasl_ssl; //SASL CAPA string for SSL mode
			readonly int expire; //we only enforce expire=0, finite limits are simply a notice of externally enforced policies
			readonly long tmtprotocol;
			readonly long delay_chanclose; //has solved abort-on-close issues in the past
			readonly string greetcore;
			readonly POP3Server prototype_server;
			readonly com.grey.mailismus.AppConfig appConfig;

			// read-only buffers - pre-allocated and pre-populated buffers, for efficient sending of canned replies
			readonly java.nio.ByteBuffer pop3rsp_ok;
			readonly java.nio.ByteBuffer pop3rsp_greet;
			readonly java.nio.ByteBuffer pop3rsp_top;
			readonly java.nio.ByteBuffer pop3rsp_invauth;
			readonly java.nio.ByteBuffer pop3rsp_dupauth;
			readonly java.nio.ByteBuffer pop3rsp_nosuchmsg;
			readonly java.nio.ByteBuffer pop3rsp_errproto;
			readonly java.nio.ByteBuffer pop3rsp_needssl;
			readonly java.nio.ByteBuffer pop3rsp_emptychallenge;
			readonly java.nio.ByteBuffer pop3rsp_endrsp;
			readonly java.nio.ByteBuffer pop3rsp_endmsg;
			java.nio.ByteBuffer altrsp_badcmd;

			// temp work areas, pre-allocated for efficiency
			readonly com.grey.base.utils.TSAP tmptsap = new com.grey.base.utils.TSAP();
			readonly stringBuilder tmpsb = new stringBuilder();
			readonly com.grey.@base.utils.ByteChars tmpbc = new com.grey.@base.utils.ByteChars();
			readonly com.grey.@base.utils.ByteChars tmplightbc = new com.grey.@base.utils.ByteChars(-1); //lightweight object without own storage
	...
	private static readonly class SaslAuthenticator
				extends com.grey.base.sasl.SaslServer.Authenticator
	{
		private readonly com.grey.mailismus.directory.Directory dtory;
		...
		public static readonly class Factory
			implements com.grey.naf.reactor.CM_Listener.ServerFactory
		{
			private readonly POP3Server prototype;
		...
		private readonly com.grey.@base.utils.ByteChars username = new com.grey.@base.utils.ByteChars();
		private readonly com.grey.@base.utils.ByteChars apopToken;
		...
		setLogPrefix();
			...
			{
				readonly int cmdlen = cmd.size();
				if (data.size() < cmdlen) return false;
				readonly byte[] cmdbuf = cmd.buffer();
				readonly byte[] databuf = data.buffer();
